...
//  enLIGHTen
//
//  Created by Dominick Lee on 2/9/20.
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificate is proof that Dominick Lee has achieved the UI Design course with approval from a Design+Code instructor.")
                .fontWeight(.bold)
